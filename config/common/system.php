...
//        'debug' => (bool)getenv('APP_DEBUG')
        ...
        'oauth' => [
            'private_key_path' => realpath(__DIR__ . '/../../storage/keys/private.key'),
    ...
    ClientRepositoryInterface::class => function (ContainerInterface $container) {
        return $container->get(\App\OAuth\Repository\ClientRepository::class);
    },
    AccessTokenRepositoryInterface::class => function (ContainerInterface $container) {
        return $container->get(\App\OAuth\Repository\AccessTokenRepository::class);
    },
    ScopeRepositoryInterface::class => function (ContainerInterface $container) {
        return $container->get(\App\OAuth\Repository\ScopeRepository::class);
    },
